...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-04-2023 a las 15:44:21
...
--
-- Base de datos: `sistemacalificacioneskinder`
--
...
INSERT INTO `salon` (`id`, `nombre`, `cupo_maximo`) VALUES
(1, '1-A', 30),
(2, '1-B', 30),
(3, '1-C', 30),
(4, '1-D', 30),
...
(14, 0, 'Paulina Abigail', 'Vazquez', 'Navarro', 'pvazquez_sec@lb.com', '123456'),
...
ALTER TABLE `curso`
  ...
  ADD KEY `curso_ibfk_1` (`id_materia`),
  ADD KEY `curso_ibfk_2` (`id_alumno`);
...
--
ALTER TABLE `curso`
  ADD CONSTRAINT `curso_ibfk_1` FOREIGN KEY (`id_materia`) REFERENCES `materia` (`id_materia`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `curso_ibfk_2` FOREIGN KEY (`id_alumno`) REFERENCES `alumno` (`id_alumno`) ON DELETE CASCADE ON UPDATE CASCADE;
